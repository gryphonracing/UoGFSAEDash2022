...
void Dump::newFrame(const can_frame& frame) {
    fmt::print("ID: 0x{:08X}, Ext: {}, RTR: {}, Err: {}, Payload: 0x{:02X} 0x{:02X} 0x{:02X} 0x{:02X} 0x{:02X} 0x{:02X} 0x{:02X} 0x{:02X}\n",
        CAN::frameId(frame), CAN::frameFormat(frame) == CanFormat::Extended, CAN::isRemoteTransmissionRequest(frame), CAN::isError(frame),
